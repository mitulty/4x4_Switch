...
rm -rf obj_vhdl
mkdir obj_vhdl
gcc -c testbench/testbench_main.c -I hw/ -I $AHIR_RELEASE/include  -o obj_vhdl/testbench.o 
gcc -c hw/vhdlCStubs.c -I hw/ -I $AHIR_RELEASE/include  -o obj_vhdl/vhdlCStubs.o 
